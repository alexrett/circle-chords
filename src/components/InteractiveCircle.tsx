...
export default function InteractiveCircle({ keyValue: keySig, modeValue: mode, onTonalityChange, majorKeys = [], minorKeys = [] }: {
  keyValue: string
  modeValue: string
    ...
    <div className="interactive-circle-container">
      ...
      >
        ...
        {angles.map((a, i) => {
          ...
          return (
            <g key={i}>
              <path d={majorPath} fill={majorFill} stroke="#dee2e6" strokeWidth={1} style={{ cursor: 'pointer' }}
